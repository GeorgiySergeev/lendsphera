...
| ------ | --- | ---------------------- | -------------------------------------------------------------------------------- | ------------ |
| [x ]   | 0.1 | Prisma domain model    | [0.1-prisma-domain-model.md](./phase-0-foundations/0.1-prisma-domain-model.md)   |              |
| [x ]   | 0.2 | Shared types package   | [0.2-shared-types-package.md](./phase-0-foundations/0.2-shared-types-package.md) |              |
| [x ]   | 0.3 | OpenAPI and API client | [0.3-openapi-and-client.md](./phase-0-foundations/0.3-openapi-and-client.md)     |              |
| [x ]   | 0.4 | Auth and RBAC          | [0.4-auth-and-rbac.md](./phase-0-foundations/0.4-auth-and-rbac.md)               |              |
| [x ]   | 0.5 | Audit log              | [0.5-audit-log.md](./phase-0-foundations/0.5-audit-log.md)                       |              |
