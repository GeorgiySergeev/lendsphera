...
export function VariantSelectPopover({
  ...
  const variants = [
    { id: "default", name: "Default (recommended)", html: component.html, css: component.css },
    ...component.variants
  ];
          ...
          <div>
            ...
            <div className="space-y-2">
              {variants.map(v => (
                ...
                >
                  <div className={`w-4 h-4 rounded-full border flex items-center justify-center ${selectedId === v.id ? 'border-primary' : 'border-input'}`}>
                    {selectedId === v.id && <div className="w-2.5 h-2.5 rounded-full bg-primary" />}
                  </div>
